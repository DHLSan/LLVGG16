...
end entity VGG16_OUTPUT1_s_axi;
...
architecture behave of VGG16_OUTPUT1_s_axi is
    ...
    component VGG16_OUTPUT1_s_axi_ram is
        generic (
            BYTES   : INTEGER :=4;
            DEPTH   : INTEGER :=256;
            AWIDTH  : INTEGER :=8);
    ...
    end component VGG16_OUTPUT1_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_result
int_result : VGG16_OUTPUT1_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 1000,
     AWIDTH   => log2(1000))
...
entity VGG16_OUTPUT1_s_axi_ram is
    generic (
        BYTES   : INTEGER :=4;
        DEPTH   : INTEGER :=256;
        AWIDTH  : INTEGER :=8);
...
end entity VGG16_OUTPUT1_s_axi_ram;

architecture behave of VGG16_OUTPUT1_s_axi_ram is
