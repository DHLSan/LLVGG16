...
proc generate {drv_handle} {
    xdefine_include_file $drv_handle "xparameters.h" "XVgg16" \
        "NUM_INSTANCES" \
        "DEVICE_ID" \
    ...
    xdefine_config_file $drv_handle "xvgg16_g.c" "XVgg16" \
        "DEVICE_ID" \
        "C_S_AXI_CONTROL_BASEADDR" \
        "C_S_AXI_INPUT_BASEADDR" \
        "C_S_AXI_OUTPUT_BASEADDR" \
    ...
    xdefine_canonical_xpars $drv_handle "xparameters.h" "XVgg16" \
        "DEVICE_ID" \
        "C_S_AXI_CONTROL_BASEADDR" \
        "C_S_AXI_CONTROL_HIGHADDR" \
        "C_S_AXI_INPUT_BASEADDR" \
