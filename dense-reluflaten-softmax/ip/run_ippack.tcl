...
set Library     "hls"
set IPName      "dense_reluflatten_softmax"
set Version     "1.0"
set DisplayName "Dense_reluflatten_softmax"
set Revision    "2107042302"
...
## Variables
set Top "dense_reluflatten_softmax"
...
set Interfaces {
    ...
    s_axi_OUTPUT {
        ...
        registers {}
        memories "class {base_address 4096 range 4096} result {base_address 8192 range 4096}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    s_axi_parameter {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_parameter"
        param_prefix "C_S_AXI_PARAMETER"
        addr_bits "16"
        port_width "AWADDR 16 WDATA 32 WSTRB 4 ARADDR 16 RDATA 32"
        registers {}
        memories "bd1 {base_address 16384 range 16384} bd2 {base_address 32768 range 16384} bd3 {base_address 49152 range 4096}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_CONTROL s_axi_INPUT s_axi_OUTPUT s_axi_parameter"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 2489592485 II x}
