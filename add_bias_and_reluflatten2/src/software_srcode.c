...
void get_VGG16() {
	...
	printf("Clock Cycle for Sofware %lf \n", 1.0*(tEnd1- tStart1)+1.0*(tEnd2- tStart2));
	printf("Add Bias and ReLU Flattan2 and Add Bias and ReLU Flattan3-softmax function in Software %lf \n", ElapsedTime1+ElapsedTime2);
