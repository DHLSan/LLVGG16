...
set Library     "hls"
set IPName      "add_bias_and_relu_flatten2"
set Version     "1.0"
set DisplayName "Add_bias_and_relu_flatten2"
set Revision    "2107041619"
...
## Variables
set Top "add_bias_and_relu_flatten2"
...
set Interfaces {
    ...
    s_axi_INPUT {
        ...
        registers {}
        memories "mem_block1_dense {base_address 16384 range 16384}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    s_axi_OUTPUT {
        ...
        port_width "AWADDR 15 WDATA 32 WSTRB 4 ARADDR 15 RDATA 32"
        registers {}
        memories "memblock1_dense {base_address 16384 range 16384}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 12299 II x}
