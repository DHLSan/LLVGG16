...
set Interfaces {
    ...
    s_axi_INPUT {
        ...
        registers {}
        memories "memblock2_dense {base_address 4096 range 4096}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_CONTROL s_axi_INPUT s_axi_OUTPUT s_axi_OUTPUT1"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 56001 II x}
