...
entity softmax_OUTPUT1_s_axi is
generic (
...
end entity softmax_OUTPUT1_s_axi;
...
architecture behave of softmax_OUTPUT1_s_axi is
    ...
    component softmax_OUTPUT1_s_axi_ram is
        generic (
            BYTES   : INTEGER :=4;
            DEPTH   : INTEGER :=256;
            AWIDTH  : INTEGER :=8);
    ...
    end component softmax_OUTPUT1_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_result
int_result : softmax_OUTPUT1_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 1000,
     AWIDTH   => log2(1000))
...
entity softmax_OUTPUT1_s_axi_ram is
    generic (
        BYTES   : INTEGER :=4;
        DEPTH   : INTEGER :=256;
        AWIDTH  : INTEGER :=8);
...
end entity softmax_OUTPUT1_s_axi_ram;

architecture behave of softmax_OUTPUT1_s_axi_ram is
