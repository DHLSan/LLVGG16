...
`timescale 1ns/1ps
module desne_reluflatten_softmax_OUTPUT1_s_axi
#(parameter
...
//------------------------Parameter----------------------
localparam
    ADDR_RESULT_BASE = 13'h1000,
    ADDR_RESULT_HIGH = 13'h1fff,
    WRIDLE           = 2'd0,
    WRDATA           = 2'd1,
    WRRESP           = 2'd2,
    WRRESET          = 2'd3,
...
//------------------------Instantiation------------------
// int_result
desne_reluflatten_softmax_OUTPUT1_s_axi_ram #(
    .BYTES    ( 4 ),
    .DEPTH    ( 1000 )
) int_result (
    .clk0     ( ACLK ),
...
assign RVALID  = (rstate == RDDATA) & !int_result_read;
...
module desne_reluflatten_softmax_OUTPUT1_s_axi_ram
#(parameter
    BYTES  = 4,
    DEPTH  = 256,
    AWIDTH = log2(DEPTH)
