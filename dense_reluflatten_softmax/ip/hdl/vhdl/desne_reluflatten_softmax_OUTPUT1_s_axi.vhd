...
entity desne_reluflatten_softmax_OUTPUT1_s_axi is
generic (
...
end entity desne_reluflatten_softmax_OUTPUT1_s_axi;
...
architecture behave of desne_reluflatten_softmax_OUTPUT1_s_axi is
    type states is (wridle, wrdata, wrresp, wrreset, rdidle, rddata, rdreset);  -- read and write fsm states
    signal wstate  : states := wrreset;
    signal rstate  : states := rdreset;
    signal wnext, rnext: states;
    constant ADDR_RESULT_BASE : INTEGER := 16#1000#;
    constant ADDR_RESULT_HIGH : INTEGER := 16#1fff#;
    ...
    component desne_reluflatten_softmax_OUTPUT1_s_axi_ram is
        generic (
            BYTES   : INTEGER :=4;
            DEPTH   : INTEGER :=256;
            AWIDTH  : INTEGER :=8);
    ...
    end component desne_reluflatten_softmax_OUTPUT1_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_result
int_result : desne_reluflatten_softmax_OUTPUT1_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 1000,
     AWIDTH   => log2(1000))
...
-- ----------------------- AXI READ ----------------------
    ...
    RRESP   <= "00";  -- OKAY
    RVALID_t  <= '1' when (rstate = rddata) and (int_result_read = '0') else '0';
    RVALID    <= RVALID_t;
...
entity desne_reluflatten_softmax_OUTPUT1_s_axi_ram is
    generic (
        BYTES   : INTEGER :=4;
        DEPTH   : INTEGER :=256;
        AWIDTH  : INTEGER :=8);
...
end entity desne_reluflatten_softmax_OUTPUT1_s_axi_ram;

architecture behave of desne_reluflatten_softmax_OUTPUT1_s_axi_ram is
