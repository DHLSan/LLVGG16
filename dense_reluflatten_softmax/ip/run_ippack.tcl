...
set Library     "hls"
set IPName      "desne_reluflatten_softmax"
set Version     "1.0"
set DisplayName "Desne_reluflatten_softmax"
set Revision    "2106252233"
...
## Variables
set Top "desne_reluflatten_softmax"
...
set Interfaces {
    ...
    s_axi_INPUT {
        ...
        registers {}
        memories "mem_block1_dense {base_address 131072 range 131072}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    s_axi_OUTPUT {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_OUTPUT"
        param_prefix "C_S_AXI_OUTPUT"
        addr_bits "13"
        port_width "AWADDR 13 WDATA 32 WSTRB 4 ARADDR 13 RDATA 32"
        registers {}
        memories "class {base_address 4096 range 4096}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    s_axi_OUTPUT1 {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_OUTPUT1"
        param_prefix "C_S_AXI_OUTPUT1"
        addr_bits "13"
        port_width "AWADDR 13 WDATA 32 WSTRB 4 ARADDR 13 RDATA 32"
        registers {}
        memories "result {base_address 4096 range 4096}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    s_axi_bias {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_bias"
        param_prefix "C_S_AXI_BIAS"
        addr_bits "15"
        port_width "AWADDR 15 WDATA 32 WSTRB 4 ARADDR 15 RDATA 32"
        registers {}
        memories "bd1 {base_address 16384 range 16384}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    s_axi_bias2 {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_bias2"
        param_prefix "C_S_AXI_BIAS2"
        addr_bits "15"
        port_width "AWADDR 15 WDATA 32 WSTRB 4 ARADDR 15 RDATA 32"
        registers {}
        memories "bd2 {base_address 16384 range 16384}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    s_axi_bias3 {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_bias3"
        param_prefix "C_S_AXI_BIAS3"
        addr_bits "13"
        port_width "AWADDR 13 WDATA 32 WSTRB 4 ARADDR 13 RDATA 32"
        registers {}
        memories "bd3 {base_address 4096 range 4096}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_CONTROL s_axi_INPUT s_axi_OUTPUT s_axi_OUTPUT1 s_axi_bias s_axi_bias2 s_axi_bias3"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 2613372577 II x}
