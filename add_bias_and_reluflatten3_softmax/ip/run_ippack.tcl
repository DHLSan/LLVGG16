...
set Library     "hls"
set IPName      "add_bias_and_relu_flatten3_Softmax"
set Version     "1.0"
set DisplayName "Add_bias_and_relu_flatten3_softmax"
set Revision    "2107041607"
...
## Variables
set Top "add_bias_and_relu_flatten3_Softmax"
...
set Interfaces {
    ...
    s_axi_INPUT {
        ...
        registers {}
        memories "mem_block2_dense {base_address 4096 range 4096}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 12060 II x}
